...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  head: () => ({
    meta: [
      ...
      { title: "budgetGenie — Smart budgeting for urban Nigeria" },
      ...
      { name: "author", content: "budgetGenie" },
      { property: "og:title", content: "budgetGenie — Smart budgeting for urban Nigeria" },
      ...
      { name: "twitter:title", content: "budgetGenie — Smart budgeting for urban Nigeria" },
